...
import fr.humanbooster.za.cadeau.repository.CategorieRepository;
...
public class CategorieResourceIT {
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getCountryName()).isEqualTo(DEFAULT_COUNTRY_NAME);
    }
    ...
    public void updateCategorie() throws Exception {
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getCountryName()).isEqualTo(UPDATED_COUNTRY_NAME);
    }
